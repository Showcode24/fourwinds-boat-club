...
export const clubInfo = {
  ...
  contact: {
    ...
    description:
      "Quick access to Ikoyi, Victoria Island, and Lekki Phase 1 by boat and road",
  },
};
...
export const amenities = [
  {
    ...
    description:
      "Direct lagoon access with private jetties and dedicated berths for members",
    icon: "Anchor",
  },
  {
    title: "Boat Repair Shop",
    description:
      "State-of-the-art facilities for yacht maintenance and repairs",
    icon: "Wrench",
  },
  {
  ...
  },
  {
    title: "Sauna & Spa",
    description:
      "Luxury wellness center for complete relaxation and rejuvenation",
    icon: "Droplets",
  },
  {
    title: "Fine Dining Restaurant",
    description:
      "Exquisite culinary experiences with panoramic waterfront views",
  ...
  },
  {
    title: "Squash Court",
    description:
      "Professional-grade courts for recreational and competitive play",
    icon: "Trophy",
  },
  {
    title: "Outdoor Pool",
  ...
  },
  {
    ...
    description:
      "24/7 dedicated support for all your maritime and lifestyle needs",
    icon: "Headset",
  },
  {
    title: "Meeting Rooms & Offices",
    description:
      "Professional spaces for corporate gatherings and private meetings",
    icon: "Building2",
  },
  {
    title: "Panoramic Elevator",
    description:
      "Modern elevator system offering breathtaking views of the marina",
    icon: "Move",
  },
  {
...
export const membershipTiers = [
  {
    ...
    type: "Individual",
    description:
      "Perfect for private individuals meeting our membership criteria",
    features: [
  ...
  },
  {
    ...
    type: "Organization",
    description:
      "Strategic relationship capital investment for corporate entities",
    features: [
...
export const exclusiveEvents = [
  {
    name: "Annual Regatta",
    description:
      "Premier sailing competition bringing together the most skilled sailors in West Africa",
    icon: "Sailboat",
  },
  {
    name: "Boating Expeditions",
    description:
      "Curated maritime adventures exploring stunning coastal destinations",
    icon: "Waves",
  },
  {
  ...
  },
  {
    name: "Member Galas",
    description:
      "Elegant evening celebrations with fine dining and premium entertainment",
    icon: "Sparkles",
  },
  {
    name: "Sunset Cruises",
  ...
  },
  {
    ...
    description:
      "Networking events designed for high-net-worth individuals and corporate leaders",
    icon: "Users",
  },
];
